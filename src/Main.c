...
int main(int argc,const char *argv[]){
    ...
    ComponentML cml = ComponentML_New(
    ...
    ComponentPack cg = ComponentML_Build(&cml);
    Component_Print(&cg);
    Component_Free(&cg);
    ...
    // ComponentPack cg = ComponentPack_Make((Component[]){
    //     ComponentPack_Make((Component[]){
    //         ComponentText_New("Hello World"),
    //         ComponentText_New("Hallo Welt!"),
    //         ComponentButton_New(1,2,3,4,5,6,"Hello World",0xFF0000FF,0xFF00FFFF),
    //         Component_Null()
    //     }),
    //     ComponentPack_Make((Component[]){
    //         ComponentButton_New(1,2,3,4,5,6,"Hello World",0xFF0000FF,0xFF00FFFF),
    ...
    // ComponentPack_Print(&cg);
    // ComponentPack_Free(&cg);
